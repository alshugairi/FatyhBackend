                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="messageModalLabel">{{ __('admin.full_message') }}</h5>
...
@push('scripts')
    <script>
        $(function() {
            $('#dt').DataTable({
                ...
                columns: [
                    ...
                    { data: 'email', name: 'email' },
                    {
                        ...
                        render: function(data, type, row) {
                            return `<button class="btn btn-primary-light btn-sm view-message" data-message="${data}">{{ __('admin.view_message') }}</button>`;
                        }
                    },
                ...
                columnDefs: [
                    @canany(['contact.delete'])
                    {
                        targets: -1,
                        render: function (data, type, row) {
                            var deleteUrl = '{{ route("admin.contact.destroy", ":id") }}';
            ...
            $('#dt').on('click', '.view-message', function() {
