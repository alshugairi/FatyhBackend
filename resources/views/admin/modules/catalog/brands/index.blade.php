...
@section('content')
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="page-title">{{ __('admin.brands') }}</h3>
                </div>
                <div class="col-sm-6 text-end">
                    ...
                    @can('admins.create')
                        <x-datatable.create href="{{ route('admin.brands.create') }}" module="{{ __('admin.brand') }}"/>
                    @endcan
                </div>
            </div>
        </div>
                ...
                columnDefs: [
                    @canany(['brands.edit','brands.delete'])
                    {
                        ...
                        "render": function (data, type, row) {
                            ...
                            var deleteUrl = '{{ route("admin.brands.destroy", ":id") }}';
