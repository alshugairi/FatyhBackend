                ...
                <div class="col-lg-9 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('admin.taxes') }}</h3>
                            <div class="card-tools">
                                ...
                                @can('admins.create')
                                    <x-datatable.create href="{{ route('admin.taxes.create') }}" module="{{ __('admin.tax') }}"/>
                                @endcan
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dt" class="table w-100">
                                    ...
                                    <tr>
                                        ...
                                        @canany(['taxes.edit','taxes.delete'])
                ...
                columnDefs: [
                        @canany(['taxes.edit','taxes.delete'])
                    {
                        ...
                        "render": function (data, type, row) {
                            var editUrl = '{{ route("admin.taxes.edit", ":id") }}';
                            editUrl = editUrl.replace(':id', row.id);

                            var deleteUrl = '{{ route("admin.taxes.destroy", ":id") }}';
