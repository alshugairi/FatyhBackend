        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-6 col-sm-12">
                    <form action="{{ route('admin.cities.store') }}" method="post" id="submitForm">
                        @method('post')
                        @csrf
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('admin.create') }} {{ __('admin.city') }}</h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <x-form.select label="true" key="input-country_id" name="country_id" :options="$countries" labelName="{{ trans('admin.country') }}"/>
                                </div>
                            </div>
                        </div>
                    </form>
