            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-6 col-sm-12">
                    <div class="list-items-horizontal mb-3">
                        <div class="row">
                            <div class="col-md-4">
                                <a href="{{ route('admin.countries.index') }}" class="list-item d-block text-center">
                                    {{ __('admin.countries') }}
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="{{ route('admin.cities.index') }}" class="list-item d-block active text-center">
                                    {{ __('admin.cities') }}
                                </a>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                @can('cities.create')
                                    <x-datatable.create href="{{ route('admin.cities.create') }}" module="{{ __('admin.city') }}"/>
                                @endcan
                            </div>
                        </div>
                        <div class="card-body">
