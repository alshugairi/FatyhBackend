                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                @can('admins.create')
                                    <x-datatable.create href="{{ route('admin.languages.create') }}" module="{{ __('admin.country') }}"/>
                                @endcan
                            </div>
                        </div>
                        <div class="card-body">
                ...
                columnDefs: [
                        @canany(['languages.edit','languages.delete'])
                    {
                        ...
                        "render": function (data, type, row) {
                            var editUrl = '{{ route("admin.languages.edit", ":id") }}';
                            editUrl = editUrl.replace(':id', row.id);

                            var deleteUrl = '{{ route("admin.languages.destroy", ":id") }}';
