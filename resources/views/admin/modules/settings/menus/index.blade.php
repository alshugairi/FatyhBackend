                ...
                <div class="col-lg-9 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('admin.menus') }}</h3>
                            <div class="card-tools">
                                ...
                                @can('menus.create')
                                    <x-datatable.create href="{{ route('admin.menus.create') }}" module="{{ __('admin.menu') }}"/>
                                @endcan
                            </div>
                        </div>
                        <div class="card-body">
                ...
                columnDefs: [
                        @canany(['menus.edit','menus.delete'])
                    {
                        ...
                        "render": function (data, type, row) {
                            var editUrl = '{{ route("admin.menus.edit", ":id") }}';
                            editUrl = editUrl.replace(':id', row.id);

                            var deleteUrl = '{{ route("admin.menus.destroy", ":id") }}';
