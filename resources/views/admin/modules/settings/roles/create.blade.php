        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-6 col-sm-12">
                    <form action="{{ route('admin.roles.store') }}" method="post" id="submitForm">
                        @method('post')
                        @csrf
                        <div class="card mb-1">
                            ...
                            <div class="card-body">
                                <x-form.input type="text" name="name" required="true" key="id-input" label="true" labelName="{{ __('admin.name') }}"/>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
