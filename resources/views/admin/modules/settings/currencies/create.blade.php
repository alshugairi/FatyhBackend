        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-6 col-sm-12">
                    <form action="{{ route('admin.currencies.store') }}" method="post" id="submitForm">
                        @method('post')
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <x-form.input col="col-md-6" type="text" label="true" name="code" required="true" labelName="{{ trans('admin.code') }}"/>
                                    <x-form.input col="col-md-6" type="text" label="true" name="symbol" required="true" labelName="{{ trans('admin.symbol') }}"/>
                                    <x-form.input col="col-md-6" type="number" label="true" name="exchange_rate" step="any" required="true" labelName="{{ trans('admin.exchange_rate') }}"/>
                                </div>
                            </div>
                        </div>
                    </form>
